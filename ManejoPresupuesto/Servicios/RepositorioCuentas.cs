...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class RepositorioCuentas: IRepositorioCuentas
    {
        ...
        //Hacer click en ObtenerPorId y hacer crl+. Para hacer pull up hacia la interfaz.. Luego ir a CuentasController
        public async Task<Cuenta> ObtenerPorId(int id, int usuarioId)
        {
            using var connection = new SqlConnection(connectionString);
            //Este Query hace un select que me trae el ID de la cuenta, balance y descripcion y el id del TipoCuenta de Cuentas haciendo INNERJOIN cin TiposCuentas, hacemos innerjoin con base en estos valores
